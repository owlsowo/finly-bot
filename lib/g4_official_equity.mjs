...
export const G4_MUTATION_ACK = "I_UNDERSTAND_THIS_MUTATES_ONLY_THE_HACKATHON_PAPER_ACCOUNT";
...
export function parseG4BrokerInstant(value, label = "Alpaca broker timestamp") {
...
function assertClock(clock, observedAt) {
  ...
  const clockAt = parseG4BrokerInstant(clock.timestamp, "Alpaca clock timestamp");
