...
9. **The technical handoff — 8 seconds.** Judges can inspect the 15 Alpaca ETF fill events, replay the options decisions, rerun the tests, and verify every number in the public repository.
