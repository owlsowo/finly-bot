...
test("measurement adapter is GET-only and isolated from the pinned trader", async () => {
  ...
  assert.match(workflow, /FINLY_CODE_VERSION: 36ce122519de1af370252459eb01948be99a7698/u);
...
test("measurement workflow is separately pinned, read-only, scheduled, and artifact-only", async () => {
  ...
  assert.match(traderWorkflow, /FINLY_CODE_VERSION: 36ce122519de1af370252459eb01948be99a7698/u);
